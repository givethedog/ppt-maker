#!/usr/bin/env python3
"""AI Trends 2025-2026 Presentation Slides (English Version)"""
...
ACCENT3 = RGBColor(0x10, 0xB9, 0x81)      # emerald
WHITE = RGBColor(0xFF, 0xFF, 0xFF)
LIGHT_GRAY = RGBColor(0xA0, 0xA0, 0xB0)
ORANGE = RGBColor(0xFF, 0x6B, 0x35)
YELLOW = RGBColor(0xFF, 0xD6, 0x00)
N8N_COLOR = RGBColor(0xEA, 0x4B, 0x71)    # n8n brand
...
def add_text(slide, left, top, width, height, text, size=18, color=WHITE, bold=False, align=PP_ALIGN.LEFT, font_name=FONT_NAME):
...
add_text(slide, Inches(1), Inches(1.5), Inches(11), Inches(1.2),
         "AI Trends 2025-2026", size=48, color=WHITE, bold=True, align=PP_ALIGN.CENTER)
...
add_text(slide, Inches(1), Inches(4.5), Inches(11), Inches(0.5),
         "IT Team Knowledge Sharing  |  March 2026", size=18, color=LIGHT_GRAY, align=PP_ALIGN.CENTER)
...
add_text(slide, Inches(1), Inches(2.0), Inches(11), Inches(1.5),
         '"What has happened in the AI world\nover the past year?"', size=40, color=WHITE, bold=True, align=PP_ALIGN.CENTER)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Key Terms You'll Hear Today", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "The Past Year: A Timeline", size=32, color=WHITE, bold=True)
...
timeline = [
    ...
    ("2025.12", "MCP to Linux Fdn", LIGHT_GRAY),
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "The LLM Race: A Five-Way Battle", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "How the Competitive Axis Has Shifted", size=32, color=WHITE, bold=True)

phases = [
    ("2024", "Competing on benchmark scores", LIGHT_GRAY),
...
for i, (year, desc, color) in enumerate(phases):
    ...
    if i < 2:
        add_text(slide, Inches(2.2), y + Inches(0.8), Inches(1), Inches(0.5),
                 "v", size=30, color=LIGHT_GRAY, align=PP_ALIGN.CENTER)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "MCP: The USB-C of AI", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "CLI vs MCP: The Efficiency Debate", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "The Return to CLI & Vibe Coding", size=32, color=WHITE, bold=True)

# Evolution stages
stages = [
    ("2023", "Autocomplete", "Copilot, Tabnine", LIGHT_GRAY),
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "From Prompt to Context Engineering", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "The 7 Elements of Context", size=32, color=WHITE, bold=True)
...
for i, (name, desc, example, color) in enumerate(elements_detail):
    ...
    add_text(slide, x + Inches(0.3), y + Inches(0.55), Inches(5.5), Inches(0.4),
             f"e.g., {example}", size=12, color=LIGHT_GRAY)
...
add_text(slide, Inches(1), Inches(1.0), Inches(11), Inches(0.8),
         "Let's recap where we are...", size=36, color=WHITE, bold=True, align=PP_ALIGN.CENTER)

bridge_items = [
    ("Models are smart enough", LIGHT_GRAY),
...
add_text(slide, Inches(1), Inches(5.5), Inches(11), Inches(0.8),
         "So what happens when all of this comes together?", size=28, color=LIGHT_GRAY, align=PP_ALIGN.CENTER)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Agentic AI: What Is It, Really?", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.8), Inches(3.1), Inches(5.2), Inches(0.5),
         "Generative AI = Chef who gives you the recipe", size=18, color=LIGHT_GRAY, bold=True)
items_gen = [
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "How Agentic AI Works", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Six Core Characteristics of Agentic AI", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "The Evolution of AI", size=32, color=WHITE, bold=True)

generations = [
    ("Gen 1", "~2022", "Rule-based Chatbots", "FAQ matching", LIGHT_GRAY),
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Single Agent vs Multi-Agent", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.8), Inches(1.6), Inches(5.2), Inches(0.5),
         "Single Agent", size=22, color=LIGHT_GRAY, bold=True)
single_items = [
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Major Agent Framework Comparison", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Agentic AI Adoption Reality", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(2.6), Inches(4.5), Inches(0.5),
         "have reached production", size=20, color=WHITE, align=PP_ALIGN.CENTER)
add_text(slide, Inches(0.5), Inches(3.2), Inches(4.5), Inches(0.5),
         "(Deloitte 2026 survey)", size=14, color=LIGHT_GRAY, align=PP_ALIGN.CENTER)
...
add_text(slide, Inches(0.5), Inches(4.5), Inches(12), Inches(0.4),
         "Five Conditions for Reaching Production", size=18, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "n8n x Agentic AI: Requirement Matching", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "n8n's Unique Position", size=32, color=WHITE, bold=True)

add_text(slide, Inches(0.5), Inches(1.1), Inches(12), Inches(0.5),
         "Agentic AI Tool Spectrum", size=18, color=LIGHT_GRAY)
...
add_text(slide, Inches(0.5), Inches(2.0), Inches(3), Inches(0.5),
         "<- For Code Experts", size=13, color=LIGHT_GRAY)
add_text(slide, Inches(9.5), Inches(2.0), Inches(3), Inches(0.5),
         "For Business Teams ->", size=13, color=LIGHT_GRAY, align=PP_ALIGN.RIGHT)
...
tools_spectrum = [
    ...
    ("Zapier", Inches(10.5), LIGHT_GRAY, "Low"),
]
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "n8n = The Agentic MCP Hub", size=32, color=WHITE, bold=True)

add_text(slide, Inches(0.5), Inches(1.1), Inches(12), Inches(0.5),
         "n8n supports MCP bidirectionally (since April 2025)", size=18, color=LIGHT_GRAY)
...
add_text(slide, Inches(0.5), Inches(5.3), Inches(12), Inches(0.5),
         "Real-World Workflow Examples", size=20, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Automotive AI + n8n Case Studies", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "An Honest Assessment: Opportunities & Challenges", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Internal System Integration: APIs Are the Key", size=32, color=WHITE, bold=True)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "The Big Picture", size=32, color=WHITE, bold=True)

flow_steps = [
    ("Models got smarter", "LLM competition", LIGHT_GRAY),
...
for i, (main_text, sub, color) in enumerate(flow_steps):
    ...
    if i < 5:
        add_text(slide, Inches(6.3), y + Inches(0.6), Inches(0.5), Inches(0.4),
                 "v", size=16, color=LIGHT_GRAY, align=PP_ALIGN.CENTER)
...
add_text(slide, Inches(0.5), Inches(0.3), Inches(12), Inches(0.7),
         "Proposed Next Steps", size=32, color=WHITE, bold=True)
...
# ── Save ──
output = "/Users/mung/git/ppt-maker/AI_Trends_2025-2026.pptx"
prs.save(output)
